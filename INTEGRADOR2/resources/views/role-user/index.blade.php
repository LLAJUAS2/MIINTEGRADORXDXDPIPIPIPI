        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('roleuser.create') }}" class="btn btn-purple btn-pill d-none d-sm-inline-block">
                ...
                <div class="col-12">
                    <div class="card">
                            ...
                            <table class="table card-table table-vcenter text-nowrap datatable">
                                ...
                                @forelse ($roleUsers as $roleUser)
                                    <tr>
										...
										<td>{{ $roleUser->nombre_rol }}</td>
                                        <td>{{ $roleUser->name }} {{ $roleUser->apPaterno }} {{ $roleUser->apMaterno }}</td> 
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item"
                                                           href="{{ route('roleuser.show',$roleUser->id) }}">
                                                            Ver
                                                        </a>
                                                        <a class="dropdown-item"
                                                           href="{{ route('roleuser.edit',$roleUser->id) }}">
                                                            Editar
                                                        </a>
                                                        <form
                                                            action="{{ route('roleuser.destroy',$roleUser->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
                       ...
                       <div class="card-footer d-flex align-items-center">
                            {!! $roleUsers->links('tablar::pagination') !!}
                        </div>
                    </div>
                </div>
            </div>
