        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('tareasusuarios.index') }}" class="btn btn-orange btn-pill d-none d-sm-inline-block">
            ...
            <div class="row row-deck row-cards">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST"
                                  action="{{ route('tareasusuarios.update', $tareasusuario->id) }}" id="ajaxForm" role="form"
                                  enctype="multipart/form-data">
                                {{ method_field('PATCH') }}
                                @csrf
                                
<div class="mb-3">
    <label class="form-label">Cambiar Usuario</label>
...
<div class="mb-3">
    <div class="form-label">Elige la tarea</div>
    ...
    <div class="form-footer">
        <div class="text-end">
            <div class="d-flex">
                <a href="{{ route('tareasusuarios.index') }}" class="btn btn-danger">Cancelar</a>
                <button type="submit" class="btn btn-primary ms-auto ajax-submit">Cambiar</button>
            </div>
        </div>
    </div>
